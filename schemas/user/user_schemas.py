...
class EmployeedCreateSchema(UserCreateSchema):
    role_id: uuid.UUID = Field(default=None, nullable=False)
...
class UserResponseSchema(BaseModel):
    ...
    phone: str = Field(default=None, nullable=False, max_length=15)
    address: str = Field(default=None, nullable=False, max_length=200)
    country: str = Field(default=None, nullable=False, max_length=100)
    city: str = Field(default=None, nullable=False, max_length=100)

    class Config:
        json_schema_extra = {
            "example": {
                "id": "123e4567-e89b-12d3-a456-426614174000",
                "identification_number": "1007896123",
                "first_name": "Gustavo",
                "last_name": "Romero",
                "user_name": "GusRom",
                "email": "example@example.com",
                "address": "Calle 45 #56-63",
                "country": "Colombia",
                "city": "Bogota D.C",
            }
        }

class EmployeedResponseSchema(BaseModel):
    id: uuid.UUID = Field(default=None, nullable=False)
    identification_number: str = Field(default=None, nullable=False, max_length=20)
    first_name: str = Field(default=None, nullable=False, max_length=100)
    last_name: str = Field(default=None, nullable=False, max_length=100)
