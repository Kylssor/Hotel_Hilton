...
class AuthenticationService:
    ...
    def sign_in_employee(self, sign_in_data: SignInEmployeedSchema) -> str:
        ...
        if not employeed:
            raise UnauthorizedException("El usuario proporcionado no está asociado con ninguna cuenta registrada. Por favor, verifique el nombre de usuario.")
    ...
    def sign_in_customer(self, sign_in_data: SignInCustomerSchema) -> str:
        ...
        if not customer:
            raise UnauthorizedException("El usuario proporcionado no está asociado con ninguna cuenta registrada. Por favor, verifique su correo electronico.")
